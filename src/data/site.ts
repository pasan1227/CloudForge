...
export const services: readonly Service[] = [
  {
    ...
    stack: ["Next.js", "TypeScript", "Postgres", "Vercel", "tRPC", "AWS"],
    accent: "teal",
    glyph: "</>",
  },
  {
    ...
    stack: ["Meta Ads", "Google Ads", "GA4", "Klaviyo", "Segment", "Mixpanel"],
    accent: "cyan",
    glyph: "↗",
  },
  {
    ...
    stack: ["Figma", "After Effects", "Cinema 4D", "Webflow", "Typetura"],
    accent: "coral",
    glyph: "✦",
  },
  {
    ...
    stack: ["Research", "Workshops", "Notion", "Miro", "Maven"],
    accent: "mist",
    glyph: "◐",
  },
] as const;
